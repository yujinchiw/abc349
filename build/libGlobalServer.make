...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/libGlobalServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libGlobalServer.a
...
ifeq ($(config),release)
  OBJDIR     = ../obj/Release/libGlobalServer
...
ifeq ($(config),debug64)
  OBJDIR     = ../obj/x64/Debug/libGlobalServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libGlobalServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -D_SQL_DEBUG -D_DEBUG -DDEBUG -D_ROBOT_DEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../GlobalServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
ifeq ($(config),release64)
  OBJDIR     = ../obj/x64/Release/libGlobalServer
  TARGETDIR  = ../bin/Release
  TARGET     = $(TARGETDIR)/libGlobalServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -DNDEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../GlobalServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
OBJECTS := \
	$(OBJDIR)/ProcessCmd.o \
	$(OBJDIR)/GlobalUserManager.o \
	$(OBJDIR)/GlobalServer.o \
...
$(OBJDIR)/ProcessCmd.o: ../GlobalServer/ProcessCmd.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/GlobalUserManager.o: ../GlobalServer/GlobalUserManager.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/GlobalServer.o: ../GlobalServer/GlobalServer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
