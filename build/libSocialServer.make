...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/libSocialServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libSocialServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -D_SQL_DEBUG -D_DEBUG -DDEBUG -D_ROBOT_DEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../SocialServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
ifeq ($(config),release)
  OBJDIR     = ../obj/Release/libSocialServer
...
ifeq ($(config),debug64)
  OBJDIR     = ../obj/x64/Debug/libSocialServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libSocialServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -D_SQL_DEBUG -D_DEBUG -DDEBUG -D_ROBOT_DEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../SocialServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
ifeq ($(config),release64)
  OBJDIR     = ../obj/x64/Release/libSocialServer
  TARGETDIR  = ../bin/Release
  TARGET     = $(TARGETDIR)/libSocialServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -DNDEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../SocialServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
OBJECTS := \
	$(OBJDIR)/UserSociality.o \
	$(OBJDIR)/SocialServer.o \
	$(OBJDIR)/SocialityManager.o \
	$(OBJDIR)/Sociality.o \
	$(OBJDIR)/ProcessCmd.o \
...
$(OBJDIR)/UserSociality.o: ../SocialServer/UserSociality.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/SocialServer.o: ../SocialServer/SocialServer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/SocialityManager.o: ../SocialServer/SocialityManager.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/Sociality.o: ../SocialServer/Sociality.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/ProcessCmd.o: ../SocialServer/ProcessCmd.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
