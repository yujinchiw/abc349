...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/testbase
  TARGETDIR  = ../bin/Test
  TARGET     = $(TARGETDIR)/testbase
  ...
  LIBS      += -lxml2 -lpthread -lmysqlclient -llog4cxx -lprotobuf -lhiredis -ljansson -ljemalloc -lbase -lgtest_main -lgtest
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LDDEPS    += ../bin/Debug/libbase.a
...
ifeq ($(config),release64)
  OBJDIR     = ../obj/x64/Release/testbase
  TARGETDIR  = ../bin/Test
  TARGET     = $(TARGETDIR)/testbase
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -DNDEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
$(OBJDIR)/xLuaDataTest.o: ../tests/base/xLuaDataTest.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
