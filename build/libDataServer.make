...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/libDataServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libDataServer.a
...
ifeq ($(config),release)
  OBJDIR     = ../obj/Release/libDataServer
...
ifeq ($(config),debug64)
  OBJDIR     = ../obj/x64/Debug/libDataServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libDataServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -D_SQL_DEBUG -D_DEBUG -DDEBUG -D_ROBOT_DEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../DataServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
ifeq ($(config),release64)
  OBJDIR     = ../obj/x64/Release/libDataServer
  TARGETDIR  = ../bin/Release
  TARGET     = $(TARGETDIR)/libDataServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -DNDEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../DataServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
OBJECTS := \
	$(OBJDIR)/RecordGCityManager.o \
	$(OBJDIR)/ProcessCmd.o \
	$(OBJDIR)/GuildPhotoLoader.o \
	$(OBJDIR)/DataServer.o \
...
$(OBJDIR)/RecordGCityManager.o: ../DataServer/RecordGCityManager.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/ProcessCmd.o: ../DataServer/ProcessCmd.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/GuildPhotoLoader.o: ../DataServer/GuildPhotoLoader.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/DataServer.o: ../DataServer/DataServer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
