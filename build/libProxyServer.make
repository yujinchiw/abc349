...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/libProxyServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libProxyServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -D_SQL_DEBUG -D_DEBUG -DDEBUG -D_ROBOT_DEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../ProxyServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
ifeq ($(config),release)
  OBJDIR     = ../obj/Release/libProxyServer
...
ifeq ($(config),debug64)
  OBJDIR     = ../obj/x64/Debug/libProxyServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libProxyServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -D_SQL_DEBUG -D_DEBUG -DDEBUG -D_ROBOT_DEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../ProxyServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
ifeq ($(config),release64)
  OBJDIR     = ../obj/x64/Release/libProxyServer
  TARGETDIR  = ../bin/Release
  TARGET     = $(TARGETDIR)/libProxyServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -DNDEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../ProxyServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
OBJECTS := \
	$(OBJDIR)/ZoneList.o \
	$(OBJDIR)/ProxyUserManager.o \
	$(OBJDIR)/ProxyUserDataThread.o \
	$(OBJDIR)/ProxyUser.o \
	$(OBJDIR)/ProxyServer.o \
...
$(OBJDIR)/ZoneList.o: ../ProxyServer/ZoneList.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/ProxyUserManager.o: ../ProxyServer/ProxyUserManager.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/ProxyUserDataThread.o: ../ProxyServer/ProxyUserDataThread.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/ProxyUser.o: ../ProxyServer/ProxyUser.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/ProxyServer.o: ../ProxyServer/ProxyServer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
