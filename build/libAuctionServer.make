...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/libAuctionServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libAuctionServer.a
...
ifeq ($(config),release)
  OBJDIR     = ../obj/Release/libAuctionServer
...
ifeq ($(config),debug64)
  OBJDIR     = ../obj/x64/Debug/libAuctionServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libAuctionServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -D_SQL_DEBUG -D_DEBUG -DDEBUG -D_ROBOT_DEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../AuctionServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
ifeq ($(config),release64)
  OBJDIR     = ../obj/x64/Release/libAuctionServer
  TARGETDIR  = ../bin/Release
  TARGET     = $(TARGETDIR)/libAuctionServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -DNDEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../AuctionServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
OBJECTS := \
	$(OBJDIR)/AuctionManager.o \
	$(OBJDIR)/TradePriceMgr.o \
	$(OBJDIR)/ProcessCmd.o \
	$(OBJDIR)/AuctionServer.o \
...
clean:
	@echo Cleaning libAuctionServer
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/AuctionManager.o: ../AuctionServer/AuctionManager.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/TradePriceMgr.o: ../AuctionServer/TradePriceMgr.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/ProcessCmd.o: ../AuctionServer/ProcessCmd.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/AuctionServer.o: ../AuctionServer/AuctionServer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
