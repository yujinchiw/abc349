...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/libTradeServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libTradeServer.a
...
ifeq ($(config),release)
  OBJDIR     = ../obj/Release/libTradeServer
...
ifeq ($(config),debug64)
  OBJDIR     = ../obj/x64/Debug/libTradeServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libTradeServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -D_SQL_DEBUG -D_DEBUG -DDEBUG -D_ROBOT_DEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../TradeServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
ifeq ($(config),release64)
  OBJDIR     = ../obj/x64/Release/libTradeServer
  TARGETDIR  = ../bin/Release
  TARGET     = $(TARGETDIR)/libTradeServer.a
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -DNDEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../TradeServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
OBJECTS := \
	$(OBJDIR)/TradeUserMgr.o \
	$(OBJDIR)/TradeServer.o \
	$(OBJDIR)/TradeManager.o \
...
$(OBJDIR)/TradeUserMgr.o: ../TradeServer/TradeUserMgr.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/TradeServer.o: ../TradeServer/TradeServer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/TradeManager.o: ../TradeServer/TradeManager.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
