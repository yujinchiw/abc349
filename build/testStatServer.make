...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/testStatServer
  TARGETDIR  = ../bin/Test
  TARGET     = $(TARGETDIR)/testStatServer
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -D_SQL_DEBUG -D_DEBUG -DDEBUG -D_ROBOT_DEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../StatServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
  ...
  LIBS      += -lxml2 -lpthread -lmysqlclient -llog4cxx -lprotobuf -lhiredis -ljansson -ljemalloc -lStatServer -lCommon -lbase -lgtest_main -lgtest
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LDDEPS    += ../bin/Debug/libStatServer.a ../bin/Debug/libCommon.a ../bin/Debug/libbase.a
...
ifeq ($(config),release)
  OBJDIR     = ../obj/Release/testStatServer
  TARGETDIR  = ../bin/Test
  TARGET     = $(TARGETDIR)/testStatServer
  ...
  LIBS      += -lxml2 -lpthread -lmysqlclient -llog4cxx -lprotobuf -lhiredis -ljansson -ljemalloc -lStatServer -lCommon -lbase -lgtest_main -lgtest
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LDDEPS    += ../bin/Release/libStatServer.a ../bin/Release/libCommon.a ../bin/Release/libbase.a
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(LDFLAGS) $(RESOURCES) $(ARCH) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),debug64)
  OBJDIR     = ../obj/x64/Debug/testStatServer
  TARGETDIR  = ../bin/Test
  TARGET     = $(TARGETDIR)/testStatServer
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -D_SQL_DEBUG -D_DEBUG -DDEBUG -D_ROBOT_DEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../StatServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
ifeq ($(config),release64)
  OBJDIR     = ../obj/x64/Release/testStatServer
  TARGETDIR  = ../bin/Test
  TARGET     = $(TARGETDIR)/testStatServer
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -DNDEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../StatServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
