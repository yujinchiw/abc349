...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/GZoneServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/GZoneServer
  ...
  LIBS      += -lxml2 -lpthread -lmysqlclient -llog4cxx -lprotobuf -lhiredis -ljansson -ljemalloc -lGZoneServer -lCommon -lbase
...
ifeq ($(config),release)
  OBJDIR     = ../obj/Release/GZoneServer
...
ifeq ($(config),debug64)
  OBJDIR     = ../obj/x64/Debug/GZoneServer
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/GZoneServer
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -D_SQL_DEBUG -D_DEBUG -DDEBUG -D_ROBOT_DEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../GZoneServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
ifeq ($(config),release64)
  OBJDIR     = ../obj/x64/Release/GZoneServer
  TARGETDIR  = ../bin/Release
  TARGET     = $(TARGETDIR)/GZoneServer
  DEFINES   += -D_GLIBCXX_USE_CXX11_ABI=0 -DNDEBUG
  INCLUDES  += -I.. -I/usr/local/include -I/usr/local/include/mysql -I/usr/local/mysql/include -I/usr/include -I/usr/include/log4cxx -I/usr/include/libxml2 -I/usr/include/mysql -I../GZoneServer -I../base -I../base/xlib -I../base/xlib/Recast -I../base/xlib/Detour -I../base/protobuf -I../base/config -I../Command -I../Common
...
$(OBJDIR)/main.o: ../GZoneServer/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
