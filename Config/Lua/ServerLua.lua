...
function exeDamage(sUser, tUser, pSkillParam)
  ...
  -- คำนวณดาเมจ
  local damage = calculateDamage(sUser, tUser, oSkill, entry1, entry2)

  -- จำกัดค่าดาเมจไม่ให้เกินขีดจำกัด
  local MAX_DAMAGE = 2147483647  -- 32-bit signed integer max value หรือกำหนดให้เหมาะสม
